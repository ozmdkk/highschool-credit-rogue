...
const GAME_DATA = {
  ...
  subjects: {
    ...
    'korean_common1': {
      ...
      quizzes: [
        ...
        {
          q: '다양한 매체를 통해 생산·유통되는 정보를 비판적으로 이해하고 주체적으로 표현하는 능력은?',
          options: ['매체 문식성(미디어 리터러시)', '단순 받아쓰기 능력', '맞춤법 자동 교정 기능', '타자 속도'],
          ans: 0,
          exp: '2022 개정 공통국어는 매체 문식성을 핵심 역량으로 강조합니다.'
        },
        {
          q: '글을 쓸 때 글의 목적, 예상 독자, 상황 맥락을 고려하여 내용을 계획하고 조직하는 활동은?',
          options: ['작문의 내용 생성과 조직', '무작정 받아 적기', '사전에 나온 문장 그대로 베끼기', '글자 수만 채우기'],
          ans: 0,
          exp: '좋은 글쓰기는 목적과 독자, 맥락을 고려한 계획과 조직에서 시작됩니다.'
        }
      ]
    },
    'math_common1': {
      ...
      quizzes: [
        ...
        {
          q: '어떤 조건을 만족하는 대상들의 모임을 명확하게 정의한 것을 무엇이라 하는가?',
          options: ['집합(Set)', '명제', '함수', '수열'],
          ans: 0,
          exp: '집합은 원소의 소속 여부가 명확히 판별되는 대상들의 모임입니다.'
        },
        {
          q: '두 집합 X, Y에서 X의 각 원소에 Y의 원소를 오직 하나씩 대응시키는 관계는?',
          options: ['함수(Function)', '수열', '방정식', '부등식'],
          ans: 0,
          exp: '함수는 정의역의 각 원소에 공역의 원소를 하나씩만 대응시키는 특별한 관계입니다.'
        }
      ]
    },
    'english_common1': {
      ...
      quizzes: [
        ...
        {
          q: '영어 지문을 읽을 때 낯선 단어의 의미를 문맥의 단서를 통해 짐작하는 전략은?',
          options: ['문맥을 통한 어휘 추론(Contextual Inference)', '사전 없이 무시하고 건너뛰기', '무조건 암기 사전 통암기', '발음만 반복 연습'],
          ans: 0,
          exp: '문맥 단서를 활용하면 모르는 단어의 의미를 효과적으로 추론할 수 있습니다.'
        },
        {
          q: '글쓴이가 특정 정보를 전달하려는지, 독자를 설득하려는지 파악하는 것은?',
          options: ['글의 목적(Purpose) 파악', '문장 길이 세기', '철자 개수 세기', '문단 수 세기'],
          ans: 0,
          exp: '글의 목적을 파악하면 글쓴이의 의도와 핵심 메시지를 정확히 이해할 수 있습니다.'
        }
      ]
    },
    'soc_common1': {
      ...
      quizzes: [
        ...
        {
          q: '사회 현상을 인간관계, 제도, 사회 구조의 측면에서 살펴보는 통합사회의 관점은?',
          options: ['사회적 관점', '시간적 관점', '공간적 관점', '윤리적 관점'],
          ans: 0,
          exp: '사회적 관점은 개인과 사회 제도·구조 간의 관계를 중심으로 현상을 탐구합니다.'
        },
        {
          q: '인간이라면 누구나 태어나면서부터 가지는, 국가도 함부로 침해할 수 없는 기본적 권리는?',
          options: ['인권(Human Rights)', '특허권', '저작권', '선거권만'],
          ans: 0,
          exp: '인권은 인간의 존엄성을 위해 보장되어야 할 보편적이고 기본적인 권리입니다.'
        }
      ]
    },
    'sci_common1': {
      ...
      quizzes: [
        ...
        {
          q: '별의 내부에서 수소가 헬륨으로 융합되며 에너지를 방출하는 반응은?',
          options: ['핵융합 반응', '핵분열 반응', '연소 반응', '중화 반응'],
          ans: 0,
          exp: '별은 핵융합 반응을 통해 에너지를 만들고 무거운 원소를 합성합니다.'
        },
        {
          q: '생태계에서 생산자, 소비자, 분해자가 유기적으로 물질과 에너지를 순환시키는 체계는?',
          options: ['생태계(Ecosystem)', '단일 개체군', '무생물 환경만', '먹이 없는 서식지'],
          ans: 0,
          exp: '생태계는 생물과 비생물 요소가 상호작용하며 물질과 에너지를 순환시키는 시스템입니다.'
        }
      ]
    },
    'korean_history1': {
      ...
      quizzes: [
        ...
        {
          q: '1876년 조선이 일본과 맺은, 근대적 형식을 갖췄지만 불평등 조항을 포함한 조약은?',
          options: ['강화도조약', '을사늑약', '한일병합조약', '제물포조약'],
          ans: 0,
          exp: '강화도조약은 조선이 외국과 맺은 최초의 근대적 조약이자 불평등 조약입니다.'
        },
        {
          q: '1987년 대통령 직선제 개헌을 이끌어낸 대규모 민주화 운동은?',
          options: ['6월 민주항쟁', '4·19 혁명', '5·18 민주화운동', '부마민주항쟁'],
          ans: 0,
          exp: '6월 민주항쟁의 결과 5년 단임 대통령 직선제로의 개헌이 이루어졌습니다.'
        }
      ]
    },
    'tech_home': {
      ...
      quizzes: [
        ...
        {
          q: '새로운 아이디어나 창작물을 만든 사람에게 독점적으로 이용할 권리를 법적으로 보장하는 제도는?',
          options: ['지식재산권(특허 등)', '무제한 복제 허용', '저작권 폐지', '아이디어 공유 금지'],
          ans: 0,
          exp: '지식재산권은 창작자의 권리를 보호하고 혁신을 장려하는 제도입니다.'
        },
        {
          q: '가족 구성원이 서로의 역할을 이해하고 협력하며 건강한 관계를 유지하는 것을 무엇이라 하는가?',
          options: ['가족 관계의 이해와 실천', '무조건적 개인주의', '역할 고정관념 강요', '소통 단절'],
          ans: 0,
          exp: '가족 관계는 상호 이해와 협력적 소통을 통해 건강하게 유지됩니다.'
        }
      ]
    },
    'music_art': {
      ...
      quizzes: [
        ...
        {
          q: '예술 작품을 감상한 후 자신의 느낌과 근거를 논리적으로 표현하는 활동은?',
          options: ['비평(Criticism)', '무작정 따라 그리기', '단순 암기', '작품 파괴'],
          ans: 0,
          exp: '비평은 작품에 대한 감상을 근거를 들어 논리적으로 표현하는 활동입니다.'
        },
        {
          q: '두 가지 이상의 음을 함께 냈을 때 어울리는 소리의 조화를 다루는 음악 요소는?',
          options: ['화성(Harmony)', '리듬', '가사', '음색만'],
          ans: 0,
          exp: '화성은 여러 음이 동시에 울릴 때 만들어지는 조화로운 소리의 구성입니다.'
        }
      ]
    },
    'sci_exp1': {
      ...
      quizzes: [
        ...
        {
          q: '실험을 수행하기 전, 관찰한 현상에 대해 잠정적으로 세우는 설명은?',
          options: ['가설(Hypothesis)', '결론', '이론', '법칙'],
          ans: 0,
          exp: '가설은 실험으로 검증하기 위해 미리 세우는 잠정적인 설명입니다.'
        },
        {
          q: '같은 조건에서 실험을 반복했을 때 유사한 결과가 나오는 정도를 무엇이라 하는가?',
          options: ['신뢰도(Reliability)', '창의성', '심미성', '경제성'],
          ans: 0,
          exp: '신뢰도는 반복 측정 시 결과가 일관되게 나오는 정도를 의미합니다.'
        }
      ]
    },
    'pe1': {
      ...
      quizzes: [
        ...
        {
          q: '근육이 반복적으로 힘을 발휘하며 오랫동안 운동을 지속할 수 있는 능력은?',
          options: ['근지구력', '순발력', '유연성', '평형성'],
          ans: 0,
          exp: '근지구력은 근육이 오랜 시간 반복적으로 힘을 낼 수 있는 능력입니다.'
        },
        {
          q: '스포츠 경기에서 규칙을 준수하고 상대를 존중하는 태도를 무엇이라 하는가?',
          options: ['스포츠맨십(페어플레이)', '반칙 위주 전략', '심판 매수', '상대 비방'],
          ans: 0,
          exp: '스포츠맨십은 규칙과 상대를 존중하며 정정당당하게 경기하는 태도입니다.'
        }
      ]
    },
    ...
    'algebra': {
      ...
      quizzes: [
        ...
        {
          q: '등비수열 an = a1 · r^(n-1)에서 r이 의미하는 것은?',
          options: ['공비(common ratio)', '공차', '첫째항', '항의 개수'],
          ans: 0,
          exp: 'r은 이웃한 항끼리의 일정한 비율인 공비를 뜻합니다.'
        },
        {
          q: '삼각함수 y = sin(x)의 그래프가 같은 모양을 반복하는 x값의 최소 간격은?',
          options: ['주기(Period) 2π', '진폭', '최댓값', '절편'],
          ans: 0,
          exp: 'sin(x) 함수는 2π를 주기로 같은 모양이 반복됩니다.'
        }
      ]
    },
    'physics': {
      ...
      quizzes: [
        ...
        {
          q: '외부에서 힘이 작용하지 않는 한 물체의 운동량 총합이 변하지 않는다는 법칙은?',
          options: ['운동량 보존 법칙', '에너지 소멸 법칙', '만유인력 법칙', '가속도 증가 법칙'],
          ans: 0,
          exp: '외력이 없으면 충돌 전후에도 계 전체의 운동량은 보존됩니다.'
        },
        {
          q: '파동에서 마루에서 다음 마루까지의 거리를 나타내는 물리량은?',
          options: ['파장(Wavelength)', '진폭', '주파수', '위상'],
          ans: 0,
          exp: '파장은 파동의 한 주기에 해당하는 공간적 길이를 의미합니다.'
        }
      ]
    },
    'chemistry': {
      ...
      quizzes: [
        ...
        {
          q: '원자, 분자 등 입자 6.02×10²³개를 묶어 세는 화학의 기본 단위는?',
          options: ['몰(mol)', '그램(g)', '리터(L)', '켈빈(K)'],
          ans: 0,
          exp: '몰은 아보가드로수만큼의 입자를 묶어 세는 화학량의 기본 단위입니다.'
        },
        {
          q: '비금속 원자들이 전자쌍을 공유하며 형성하는 화학 결합은?',
          options: ['공유결합(Covalent Bond)', '이온결합', '금속결합', '수소결합만'],
          ans: 0,
          exp: '공유결합은 원자들이 전자쌍을 공유하여 안정한 구조를 이루는 결합입니다.'
        }
      ]
    },
    'biology': {
      ...
      quizzes: [
        ...
        {
          q: '생명체가 체내 환경을 일정하게 유지하려는 조절 작용을 무엇이라 하는가?',
          options: ['항상성(Homeostasis)', '돌연변이', '광합성', '삼투압 붕괴'],
          ans: 0,
          exp: '항상성은 체온, 혈당 등 체내 환경을 일정하게 유지하려는 생명현상입니다.'
        },
        {
          q: '생체 내 화학반응의 속도를 높여주는 단백질 성분의 생체 촉매는?',
          options: ['효소(Enzyme)', '호르몬 전체', '항체', '지방'],
          ans: 0,
          exp: '효소는 활성화 에너지를 낮춰 생체 반응 속도를 크게 높이는 촉매입니다.'
        }
      ]
    },
    'earth_sci': {
      ...
      quizzes: [
        ...
        {
          q: '지진이 발생했을 때 가장 먼저 도달하는, 고체와 액체를 모두 통과하는 지진파는?',
          options: ['P파(1차 파)', 'S파(2차 파)', '표면파', '중력파'],
          ans: 0,
          exp: 'P파는 속도가 가장 빠르며 고체·액체·기체를 모두 통과하는 지진파입니다.'
        },
        {
          q: '태양계가 형성될 때 원시 태양 주위 기체와 먼지가 모여 만들어진 원반 구조는?',
          options: ['원시 행성계 원반', '블랙홀', '초신성 잔해', '오르트 구름 전체'],
          ans: 0,
          exp: '원시 행성계 원반의 물질이 뭉쳐 태양과 행성들이 형성되었습니다.'
        }
      ]
    },
    'calculus1': {
      ...
      quizzes: [
        ...
        {
          q: '함수 f(x)가 x=a에서 극한값과 함숫값이 일치할 때, 이 함수는 그 점에서 무엇이라 하는가?',
          options: ['연속(Continuous)이다', '미분 불가능하다', '발산한다', '정의되지 않는다'],
          ans: 0,
          exp: '극한값과 함숫값이 일치하면 그 점에서 함수는 연속입니다.'
        },
        {
          q: '위치함수를 시간에 대해 미분하면 얻어지는, 물체의 순간적인 빠르기와 방향을 나타내는 양은?',
          options: ['속도(Velocity)', '거리', '질량', '넓이'],
          ans: 0,
          exp: '위치를 시간으로 미분하면 순간 속도를 구할 수 있습니다.'
        }
      ]
    },
    'info': {
      ...
      quizzes: [
        ...
        {
          q: '데이터를 순서대로 저장하고 마지막에 넣은 것을 가장 먼저 꺼내는(LIFO) 자료구조는?',
          options: ['스택(Stack)', '큐(Queue)', '트리', '그래프'],
          ans: 0,
          exp: '스택은 나중에 들어간 데이터가 먼저 나오는 후입선출 구조입니다.'
        },
        {
          q: '전 세계의 컴퓨터 네트워크를 하나로 연결하여 정보를 주고받는 거대한 통신망은?',
          options: ['인터넷(Internet)', '단일 하드디스크', '개인 USB', '단독 서버 한 대'],
          ans: 0,
          exp: '인터넷은 전 세계 네트워크를 상호 연결한 정보통신망입니다.'
        }
      ]
    },
    'soc_culture': {
      ...
      quizzes: [
        ...
        {
          q: '한 사회의 문화를 그 사회의 맥락에서 이해하려는, 문화에 우열이 없다고 보는 태도는?',
          options: ['문화 상대주의', '자문화 중심주의', '문화 사대주의', '문화 제국주의'],
          ans: 0,
          exp: '문화 상대주의는 각 문화를 그 사회의 맥락 속에서 이해하려는 태도입니다.'
        },
        {
          q: '개인이 사회 구성원으로서 필요한 가치와 규범을 학습하는 과정을 돕는 대표적 기관은?',
          options: ['가족·학교 등 사회화 기관', '재판소', '군대만', '기업 이사회'],
          ans: 0,
          exp: '가족과 학교는 개인의 사회화를 돕는 대표적인 사회화 기관입니다.'
        }
      ]
    },
    'world_history': {
      ...
      quizzes: [
        ...
        {
          q: '14~16세기 이탈리아에서 시작되어 고대 그리스·로마 문화를 부흥시키려 한 문예운동은?',
          options: ['르네상스(문예부흥)', '종교개혁', '계몽주의', '낭만주의'],
          ans: 0,
          exp: '르네상스는 인간 중심의 고전 문화 부흥을 지향한 문예운동입니다.'
        },
        {
          q: '2차 세계대전 이후 미국과 소련을 중심으로 한 자유진영과 공산진영의 대립 구도는?',
          options: ['냉전(Cold War)', '나폴레옹전쟁', '십자군전쟁', '아편전쟁'],
          ans: 0,
          exp: '냉전은 직접적 무력 충돌 없이 이념적으로 대립한 국제 질서였습니다.'
        }
      ]
    },
    'global_geo': {
      ...
      quizzes: [
        ...
        {
          q: '현세대의 필요를 충족하면서도 미래세대의 필요 충족 능력을 해치지 않는 발전을 무엇이라 하는가?',
          options: ['지속가능발전(Sustainable Development)', '무한 개발', '자원 고갈형 개발', '단기 이익 우선 개발'],
          ans: 0,
          exp: '지속가능발전은 환경과 개발의 균형을 추구하는 국제사회의 핵심 목표입니다.'
        },
        {
          q: '전쟁, 재해, 박해를 피해 다른 나라로 강제로 이주해야 했던 사람들을 무엇이라 하는가?',
          options: ['난민(Refugee)', '관광객', '유학생', '주재원'],
          ans: 0,
          exp: '난민은 생명이나 자유에 대한 위협을 피해 본국을 떠난 사람들입니다.'
        }
      ]
    },
    'geometry': {
      ...
      quizzes: [
        ...
        {
          q: '두 벡터의 크기와 이루는 각의 코사인 값을 곱해 하나의 실수로 나타내는 연산은?',
          options: ['벡터의 내적(Dot Product)', '벡터의 외적', '벡터의 합', '벡터의 크기'],
          ans: 0,
          exp: '내적은 두 벡터 사이의 각도와 크기 관계를 실수로 나타내는 연산입니다.'
        },
        {
          q: '3차원 공간에서 점의 위치를 x, y, z 세 값으로 나타내는 좌표계는?',
          options: ['공간좌표(3차원 직교좌표계)', '극좌표계만', '평면좌표', '원기둥좌표만'],
          ans: 0,
          exp: '공간좌표는 세 개의 축을 이용해 3차원 공간의 점을 나타냅니다.'
        }
      ]
    },
    'modern_ethics': {
      ...
      quizzes: [
        ...
        {
          q: '인간과 자연의 관계를 성찰하며 환경 보전의 도덕적 책임을 다루는 응용윤리 분야는?',
          options: ['환경윤리', '생명윤리', '정보윤리', '성 윤리'],
          ans: 0,
          exp: '환경윤리는 자연에 대한 인간의 도덕적 책임과 지속가능성을 탐구합니다.'
        },
        {
          q: '자신이 맡은 일에 대해 책임감을 가지고 성실하게 수행해야 한다는 직업 관련 윤리는?',
          options: ['직업윤리', '정보윤리', '생명윤리', '환경윤리'],
          ans: 0,
          exp: '직업윤리는 자신의 직무에서 지켜야 할 책임감과 성실성을 강조합니다.'
        }
      ]
    },
    'mechanics_energy': {
      ...
      quizzes: [
        ...
        {
          q: '물체에 작용한 힘과 그 힘이 작용한 시간의 곱으로 정의되며, 운동량의 변화량과 같은 물리량은?',
          options: ['충격량(Impulse)', '일률', '가속도', '변위'],
          ans: 0,
          exp: '충격량은 힘과 작용 시간의 곱이며, 물체의 운동량 변화량과 같습니다.'
        },
        {
          q: '열은 일로, 일은 열로 전환될 수 있으며 이 과정에서 에너지 총량은 보존된다는 법칙은?',
          options: ['열역학 제1법칙', '열역학 제2법칙', '보일의 법칙', '샤를의 법칙'],
          ans: 0,
          exp: '열역학 제1법칙은 에너지 보존 법칙을 열과 일의 관점에서 설명한 것입니다.'
        }
      ]
    },
    'fusion_science_inquiry': {
      ...
      quizzes: [
        ...
        {
          q: '수집한 데이터를 분석하여 객관적 근거에 기반해 판단을 내리는 접근 방식은?',
          options: ['데이터 기반 의사결정', '직감에 의존한 결정', '다수결로만 결정', '무작위 결정'],
          ans: 0,
          exp: '데이터 기반 의사결정은 객관적 근거를 바탕으로 합리적 판단을 내리는 방식입니다.'
        },
        {
          q: '과학기술의 발전이 사회에 미치는 영향과 사회적 요구가 과학기술에 미치는 영향을 함께 탐구하는 관점은?',
          options: ['과학기술과 사회(STS)의 상호작용', '과학은 사회와 무관하다는 관점', '기술 결정론만 인정', '사회 요인 완전 배제'],
          ans: 0,
          exp: 'STS(Science-Technology-Society)는 과학기술과 사회가 서로 영향을 주고받는다고 봅니다.'
        }
      ]
    },
    ...
    'ai_basic': {
      ...
      quizzes: [
        ...
        {
          q: '정답(레이블)이 주어진 데이터를 이용해 모델을 학습시키는 머신러닝 방식은?',
          options: ['지도학습(Supervised Learning)', '비지도학습', '강화학습만', '무작위학습'],
          ans: 0,
          exp: '지도학습은 입력과 정답(레이블)이 쌍으로 주어진 데이터로 모델을 훈련합니다.'
        },
        {
          q: '인공지능 모델 학습 전, 결측치 처리나 정규화 등 데이터를 다듬는 과정은?',
          options: ['데이터 전처리(Preprocessing)', '모델 배포', '하이퍼파라미터 튜닝만', '결과 시각화'],
          ans: 0,
          exp: '데이터 전처리는 학습 품질을 높이기 위해 데이터를 정제하는 필수 과정입니다.'
        }
      ]
    },
    'calculus2': {
      ...
      quizzes: [
        ...
        {
          q: '복잡한 함수의 적분을 쉬운 형태로 바꾸기 위해 변수를 다른 변수로 바꾸는 적분 기법은?',
          options: ['치환적분법', '부분분수분해', '인수분해', '완전제곱식'],
          ans: 0,
          exp: '치환적분법은 변수를 치환해 적분식을 더 간단한 형태로 바꾸는 기법입니다.'
        },
        {
          q: '수열의 항을 무한히 더한 합으로, 수렴하거나 발산할 수 있는 것은?',
          options: ['무한급수(Infinite Series)', '유한수열', '등차수열의 합만', '단항식'],
          ans: 0,
          exp: '무한급수는 수열의 항을 끝없이 더한 것으로, 그 합이 수렴할 수도 발산할 수도 있습니다.'
        }
      ]
    },
    'robotics_eng': {
      ...
      quizzes: [
        ...
        {
          q: '로봇이 센서로 결과를 감지해 다음 동작을 스스로 조정하는 제어 방식은?',
          options: ['피드백 제어(Feedback Control)', '개회로 제어만', '무작위 제어', '수동 조작만'],
          ans: 0,
          exp: '피드백 제어는 출력 결과를 다시 입력에 반영해 정밀하게 동작을 보정합니다.'
        },
        {
          q: '공학 설계 과정에서 아이디어를 실제로 시험해보기 위해 만드는 시제품은?',
          options: ['프로토타입(Prototype)', '최종 양산품', '설계도면만', '광고 시안'],
          ans: 0,
          exp: '프로토타입은 설계를 검증하고 개선하기 위해 미리 만들어보는 시제품입니다.'
        }
      ]
    },
    'quantum_em': {
      ...
      quizzes: [
        ...
        {
          q: '자기장이 변화할 때 도선에 전류가 유도되는 현상은?',
          options: ['전자기 유도(Electromagnetic Induction)', '광전효과', '도플러효과', '중력렌즈효과'],
          ans: 0,
          exp: '전자기 유도는 발전기 등 전기 생산의 기본 원리입니다.'
        },
        {
          q: '입자의 위치와 운동량을 동시에 정확히 측정할 수 없다는 양자역학의 핵심 원리는?',
          options: ['불확정성 원리(Uncertainty Principle)', '상대성 원리', '보존 법칙', '중첩 붕괴 법칙'],
          ans: 0,
          exp: '하이젠베르크의 불확정성 원리는 미시세계 측정의 근본적 한계를 설명합니다.'
        }
      ]
    },
    'gene_heredity': {
      ...
      quizzes: [
        ...
        {
          q: 'DNA 염기서열이 변화하여 유전 정보에 변이가 생기는 현상은?',
          options: ['돌연변이(Mutation)', '감수분열', '수정', '전사'],
          ans: 0,
          exp: '돌연변이는 유전 정보의 변화로, 생물 다양성의 원천이 되기도 합니다.'
        },
        {
          q: '세포 분열 전, DNA가 원래와 똑같은 두 개의 복사본으로 정확히 복제되는 과정은?',
          options: ['DNA 복제(Replication)', 'DNA 전사', 'DNA 번역', '단백질 합성'],
          ans: 0,
          exp: 'DNA 복제를 통해 세포 분열 시 유전정보가 정확하게 전달됩니다.'
        }
      ]
    },
    'politics_law_soc': {
      ...
      quizzes: [
        ...
        {
          q: '국민이 대표자를 직접, 비밀, 평등하게 선출하는 민주 선거의 기본 원칙에 포함되지 않는 것은?',
          options: ['제한선거', '보통선거', '평등선거', '비밀선거'],
          ans: 0,
          exp: '민주선거의 4대 원칙은 보통·평등·직접·비밀 선거이며 제한선거는 반민주적 원칙입니다.'
        },
        {
          q: '개인 간의 재산, 계약, 가족관계 등 사적인 법률관계를 규율하는 법은?',
          options: ['민법(Civil Law)', '형법', '헌법', '행정법'],
          ans: 0,
          exp: '민법은 개인 간의 사적 법률관계를 다루는 대표적인 사법입니다.'
        }
      ]
    },
    'intl_relations': {
      ...
      quizzes: [
        ...
        {
          q: '국가 간의 관계를 규율하며 조약과 국제 관습을 바탕으로 성립하는 법 체계는?',
          options: ['국제법(International Law)', '국내 민법', '지방 조례', '사내 규정'],
          ans: 0,
          exp: '국제법은 국가 간 조약과 관습을 근거로 국제 관계를 규율하는 법입니다.'
        },
        {
          q: '교통과 정보통신의 발달로 국가 간 상호의존성이 커지고 하나의 지구촌으로 통합되는 현상은?',
          options: ['세계화(Globalization)', '고립주의', '쇄국주의', '보호무역 강화'],
          ans: 0,
          exp: '세계화는 경제, 문화, 정보 등이 국경을 넘어 긴밀히 연결되는 현상입니다.'
        }
      ]
    },
    'social_problem': {
      ...
      quizzes: [
        ...
        {
          q: '설문조사처럼 수치화된 자료를 통계적으로 분석하는 사회 탐구 방법은?',
          options: ['양적 연구방법', '질적 연구방법만 사용', '무작위 추측', '감으로 판단'],
          ans: 0,
          exp: '양적 연구방법은 수치화된 자료를 통계적으로 분석해 일반화된 결론을 도출합니다.'
        },
        {
          q: '사회적 약자에게 실질적 기회의 평등을 보장하기 위해 우선적으로 지원하는 정책은?',
          options: ['적극적 우대 조치(사회적 배려)', '기회의 완전한 무시', '강자 우선 지원', '무조건적 획일 지원'],
          ans: 0,
          exp: '적극적 우대 조치는 구조적 불평등을 완화하기 위한 정책적 배려입니다.'
        }
      ]
    },
    'media_comm': {
      ...
      quizzes: [
        ...
        {
          q: '개인 맞춤형 추천 알고리즘으로 인해 편향된 정보만 반복적으로 노출되는 현상은?',
          options: ['필터 버블(Filter Bubble)', '팩트체크', '정보 공유', '균형 보도'],
          ans: 0,
          exp: '필터 버블은 알고리즘이 이용자의 성향에 맞는 정보만 보여줘 시야를 좁히는 현상입니다.'
        },
        {
          q: '타인이 창작한 글, 사진, 영상을 무단으로 사용하지 않고 출처를 밝히거나 허락을 구해야 하는 권리는?',
          options: ['저작권(Copyright)', '초상권 무시', '표절 권장', '무단 도용 허용'],
          ans: 0,
          exp: '저작권은 창작물에 대한 창작자의 권리를 법적으로 보호합니다.'
        }
      ]
    },
    'music_media': {
      ...
      quizzes: [
        ...
        {
          q: '기존 음원의 일부를 잘라 새로운 곡에 재구성해 활용하는 음악 제작 기법은?',
          options: ['샘플링(Sampling)', '라이브 녹음만', '아날로그 필사', '무음 처리'],
          ans: 0,
          exp: '샘플링은 기존 사운드를 가져와 새로운 창작물에 활용하는 기법입니다.'
        },
        {
          q: '영상이나 게임에서 발소리, 문 여닫는 소리처럼 현실감을 더하는 짧은 소리 요소는?',
          options: ['효과음(Sound Effect)', '배경음악 전체', '대사', '자막'],
          ans: 0,
          exp: '효과음은 장면의 현실감과 몰입감을 높이는 짧은 음향 요소입니다.'
        }
      ]
    },
    'economics': {
      ...
      quizzes: [
        ...
        {
          q: '가격이 오르면 공급량이 늘고, 가격이 내리면 공급량이 줄어드는 일반적 관계는?',
          options: ['공급의 법칙', '수요의 법칙', '한계효용 체감의 법칙', '희소성의 원칙'],
          ans: 0,
          exp: '공급의 법칙은 가격과 공급량이 같은 방향으로 움직이는 경향을 설명합니다.'
        },
        {
          q: '한 나라의 물가 수준이 지속적으로 상승하는 경제 현상은?',
          options: ['인플레이션(Inflation)', '디플레이션', '균형가격', '경상수지'],
          ans: 0,
          exp: '인플레이션은 화폐 가치 하락과 함께 물가가 지속적으로 오르는 현상입니다.'
        }
      ]
    },
    'chem_reactions_world': {
      ...
      quizzes: [
        ...
        {
          q: '한 물질이 전자를 잃고 다른 물질이 전자를 얻는 반응을 통칭하는 개념은?',
          options: ['산화-환원 반응', '중화 반응만', '침전 반응만', '가수분해만'],
          ans: 0,
          exp: '산화-환원 반응은 전자의 이동을 동반하는 화학 반응입니다.'
        },
        {
          q: '화학 반응이 일어나며 열을 방출하여 주변 온도를 높이는 반응은?',
          options: ['발열 반응', '흡열 반응', '무반응', '평형 상태'],
          ans: 0,
          exp: '발열 반응은 반응 과정에서 에너지를 열의 형태로 방출합니다.'
        }
      ]
    },
    'ai_math': {
      ...
      quizzes: [
        ...
        {
          q: '데이터가 평균으로부터 얼마나 퍼져 있는지를 수치로 나타내는 통계량은?',
          options: ['분산(Variance)', '중앙값', '최빈값', '합계'],
          ans: 0,
          exp: '분산은 데이터의 흩어진 정도를 나타내는 대표적인 통계량입니다.'
        },
        {
          q: '벡터의 크기(길이)를 수학적으로 나타내는 개념으로, 인공지능 모델의 거리 계산에 자주 쓰이는 것은?',
          options: ['벡터의 노름(Norm)', '벡터의 방향', '벡터의 색인', '벡터의 이름'],
          ans: 0,
          exp: '노름은 벡터의 크기를 나타내며 유클리드 거리 계산 등에 활용됩니다.'
        }
      ]
    },
    'literature_and_film': {
      ...
      quizzes: [
        ...
        {
          q: '영화의 한 장면 안에서 배우의 동선, 조명, 소품 배치 등을 통해 의미를 구성하는 연출 기법은?',
          options: ['미장센(Mise-en-scène)', '내레이션', '자막 처리', '음향 더빙'],
          ans: 0,
          exp: '미장센은 화면 안의 모든 시각 요소를 배치해 의미를 전달하는 연출 방식입니다.'
        },
        {
          q: '서로 다른 장면들을 이어 붙여 새로운 의미나 리듬을 만들어내는 영상 편집 기법은?',
          options: ['몽타주(Montage)', '롱테이크', '보이스오버', '플래시백만'],
          ans: 0,
          exp: '몽타주는 쇼트들을 연결해 새로운 시간적·의미적 흐름을 창조하는 편집 기법입니다.'
        }
      ]
    }
  },
  ...
  bosses: [
    {
      ...
      quizzes: [
        ...
        {
          q: '2022 개정 교육과정에서 보통교과와 함께 전문적인 직무 역량을 기르는 교과 영역은?',
          options: ['전문교과(전문 공통·전공 등)', '창의적 체험활동만', '자율활동만', '방과후학교만'],
          ans: 0,
          exp: '보통교과 외에 특성화고 등에서는 전문교과를 통해 직무 역량을 기릅니다.'
        },
        {
          q: '고교학점제에서 교과 학점 외에 자율·동아리·진로 활동 등으로 채우는 18학점의 영역은?',
          options: ['창의적 체험활동', '방과후 자율학습', '보충수업', '자유학기제'],
          ans: 0,
          exp: '창의적 체험활동은 자율, 동아리, 진로 활동 등으로 구성된 18학점 영역입니다.'
        }
      ]
    },
    {
      ...
      quizzes: [
        ...
        {
          q: '한 학교에서 개설하기 어려운 소인수 선택과목을 여러 학교가 함께 개설해 운영하는 제도는?',
          options: ['공동교육과정(온·오프라인)', '방과후학교', '자율학습', '전학'],
          ans: 0,
          exp: '공동교육과정은 학생의 다양한 과목 선택권을 보장하기 위한 학교 간 협력 제도입니다.'
        },
        {
          q: '고교학점제에서 학생의 성취수준을 상대적 등수가 아닌 절대적 도달 정도로 평가하는 방식은?',
          options: ['성취평가제(절대평가)', '상대평가(석차 9등급)', '무평가', '출석만으로 평가'],
          ans: 0,
          exp: '성취평가제는 학생이 성취기준에 얼마나 도달했는지를 기준으로 평가합니다.'
        }
      ]
    },
    {
      ...
      quizzes: [
        ...
        {
          q: '고교학점제가 궁극적으로 지향하는 교육의 목표는?',
          options: ['학생 개개인의 진로와 적성에 맞는 맞춤형 성장', '모든 학생에게 동일한 과목 강제', '입시 점수 경쟁만 강화', '학생의 선택권 최소화'],
          ans: 0,
          exp: '고교학점제는 학생 개개인의 적성과 진로에 맞춘 맞춤형 교육을 목표로 합니다.'
        },
        {
          q: '고교학점제 졸업 사정에서 학교가 최종적으로 확인해야 할 것은?',
          options: ['192학점 이수 여부와 각 과목의 학업성취기준 도달 여부', '출석일수만 확인', '체육대회 참가 여부만', '동아리 가입 여부만'],
          ans: 0,
          exp: '졸업 사정에서는 총 이수 학점과 함께 각 과목의 성취기준 도달 여부를 함께 확인합니다.'
        }
      ]
    }
  ],
  ...
  endings: [
    ...
    // ===== 히든 엔딩 (플레이 스타일 기반, 트랙/학점 엔딩보다 우선 판정) =====
    {
      id: 'perfect_scholar',
      title: '💯 단 한 문제도 틀리지 않은 완벽한 모범생',
      track: 'any',
      minCredits: 192,
      badge: '🏆 전과목 만점 그랜드슬램상',
      summary: '3년 내내 단 한 번의 오답도 없이 모든 개념 퀴즈와 심화 탐구 문제를 완벽하게 통과했습니다. 흔들림 없는 학업 역량의 정수를 보여주었습니다.',
      nextStep: '치밀한 준비성과 완벽주의는 어떤 시험과 평가 앞에서도 흔들리지 않는 강력한 무기가 될 것입니다.'
    },
    {
      id: 'skill_specialist',
      title: '🔥 위기를 정면돌파하는 심화 탐구 스페셜리스트',
      track: 'any',
      minCredits: 170,
      badge: '🏆 심화 탐구 마스터상',
      summary: '기본 개념에 안주하지 않고 매 순간 고난도 심화 탐구 스킬로 정면 승부했습니다. 높은 리스크를 감수하는 도전적인 학습 스타일이 돋보입니다.',
      nextStep: '어려운 문제일수록 피하지 않고 정면으로 부딪히는 자세는 대학과 사회 어디서든 두각을 나타낼 원동력입니다.'
    }
  ]
};
